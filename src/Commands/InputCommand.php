...
class InputCommand extends Command
{
    ...
    protected function configure()
    {
        $this
        	...
        	->setHelp('
                Parses the number of bottles as the first parameter and the its heights as a comma separated 
                list as the second.'
            );
    ...
    {
        $bottlesThrown = $this->calculatorManager->calculate(
            $input->getArgument('bottles'), 
            $input->getArgument('heights')
        );
